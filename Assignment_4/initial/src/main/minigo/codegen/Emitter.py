...
class Emitter():
    ...
    def getJVMType(self, inType):
        ...
        if typeIn is BoolType:
            ...
            dim_prefix = "[" * len(inType.dimens)
            return dim_prefix + self.getJVMType(inType.eleType)
    ...
    *    @param typ the type of the constant
    ...
    def emitALOAD(self, in_, frame):
        ...
        elif type(in_) is Id  or type(in_) is StringType or type(in_) is ArrayType:
            return self.jvm.emitAALOAD()
        else:
    ...
    *   @param toLabel the ending label  of the scope where the variable is active.
    ...
    def emitREADVAR(self, name, inType, index, frame):
        ...
        elif type(inType) is cgen.ArrayType or type(inType) is Id  or type(inType) is StringType:
    ...
    *   @param in the type of the returned expression.
    ...
    def emitRETURN(self, in_, frame):
        ...
        if type(in_) is IntType or type(in_) is BoolType:
            ...
            frame.pop()
            return self.jvm.emitARETURN()
        elif type(in_) is cgen.ClassType or type(in_) is Id:
            frame.pop()
            return self.jvm.emitARETURN()
    ...
    *   .super java/lang/Object<p>
    ...
    #* tạo ra array nhiều chiều địa chỉ
    #* @param in_ kiểu dữ liệu của mảng
    #* @param size kích thước của mảng
    #* @param frame frame hiện tại
    #* @return mã bytecode cho việc tạo ra mảng nhiều chiều
    ...
    *   @param in the code to be printed out
    ...
    def printout(self, in_):
        #in_: String
        # if in_ is None:
        #     print("[DEBUG] emit function returned None!")
        #     import traceback
        #     traceback.print_stack()
        #     # Either raise exception or replace with empty string
        #     in_ = "" # or raise Exception("Emit function returned None")
